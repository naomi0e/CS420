...
//    private TreeItem<String> item;
  ...
  //using hashmap to track item info and their rectangle;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
	    ...
	    Item commandCenterItem = new Item("Drone", 50, 70, 10, 10);
        ...
        Item barnItem = new Item("Cattle", 70, 220, 10, 10);
        barnContainerItems.add(barnItem);
        ItemContainer barnContainer = new ItemContainer("Barn",barnContainerItems,70,200,100,100);
